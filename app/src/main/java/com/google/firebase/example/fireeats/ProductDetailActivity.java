...
public class ProductDetailActivity extends AppCompatActivity
    ...
    public static final String KEY_RESTAURANT_ID = "key_product_id";
    ...
    @BindView(R.id.product_num_ratings)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String productId = getIntent().getExtras().getString(KEY_RESTAURANT_ID);
        if (productId == null) {
        ...
        // Get ratings
        Query ratingsQuery = mProductRef
                .collection("ratings")
    ...
    /**
     * Listener for the Product document ({@link #mProductRef}).
     */
    @Override
    public void onEvent(DocumentSnapshot snapshot, FirebaseFirestoreException e) {
        ...
        onProductLoaded(snapshot.toObject(Product.class));
    }
    ...
    private void onProductLoaded(Product product) {
        ...
        mCityView.setText(product.getCity());
        mCategoryView.setText(product.getCategory());
        mPriceView.setText(ProductUtil.getPriceString(product));
    ...
    @OnClick(R.id.product_button_back)
    ...
    private Task<Void> addRating(final DocumentReference productRef, final Rating rating) {
        // Create reference for new rating, for use inside the transaction
        final DocumentReference ratingRef = productRef.collection("ratings").document();

        // In a transaction, add the new rating and update the aggregate totals
        return mFirestore.runTransaction(new Transaction.Function<Void>() {
            @Override
            public Void apply(Transaction transaction) throws FirebaseFirestoreException {
                Product product = transaction.get(productRef).toObject(Product.class);
